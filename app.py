...
with st.sidebar:
    ...
    st.markdown(
        "- Mức lương của sinh viên công nghệ thông tin chất lượng cao sau khi ra trường là?"
    )
    st.markdown("- Giới thiệu ngành kỹ thuật robot và trí tuệ nhân tạo")
    st.markdown("- Ngành công nghệ thông tin có bao nhiêu chuyên ngành")
...
<div style="text-align: center;">
    ...
    <h1 style="color: #0078D7;">Chatbot</h1>
</div>
""", unsafe_allow_html=True)


st.markdown("""
<p style="text-align: center; font-size: 18px; color: #F08080;"><b>
    Xin chào! Rất vui khi được hỗ trợ anh/chị trong việc tìm kiếm thông tin.</b>
</p>
""", unsafe_allow_html=True)
...
user_query = st.text_input("Enter your question:", placeholder="Vui lòng nhập câu hỏi ở đây!")
